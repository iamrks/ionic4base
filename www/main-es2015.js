...
/***/ "./node_modules/raw-loader/index.js!./src/app/components/side-menu/side-menu.component.html":
/*!*****************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/components/side-menu/side-menu.component.html ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<ion-list>\n  <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages\">\n    <ion-item [routerDirection]=\"'root'\" (click)=\"onItemClick(p)\">\n      <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\n      <ion-label>\n        {{p.title}}\n      </ion-label>\n    </ion-item>\n  </ion-menu-toggle>\n</ion-list>"
...
/* harmony import */ var _services_auth_garud_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/auth-garud.service */ "./src/app/services/auth-garud.service.ts");
...
const routes = [
    ...
    },
    {
        ...
        canActivate: [_services_auth_garud_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'list',
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, authService, router, loaderService, menuCtrl) {
    ...
    initializeApp() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const res = yield this.authService.isLoggedIn();
            if (res) {
...
/* harmony import */ var _core_auth_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./core/auth.interceptor */ "./src/app/core/auth.interceptor.ts");
/* harmony import */ var _services_auth_garud_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/auth-garud.service */ "./src/app/services/auth-garud.service.ts");
/* harmony import */ var _components_side_menu_side_menu_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/side-menu/side-menu.component */ "./src/app/components/side-menu/side-menu.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _components_side_menu_side_menu_component__WEBPACK_IMPORTED_MODULE_14__["SideMenuComponent"]
        ],
        entryComponents: [],
        imports: [
        ...
        providers: [
            ...
            _services_auth_garud_service__WEBPACK_IMPORTED_MODULE_13__["AuthGuard"],
            { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicRouteStrategy"] },
            {
                ...
                useClass: _core_auth_interceptor__WEBPACK_IMPORTED_MODULE_12__["AuthInterceptor"],
                multi: true
            }
        ],
...
SideMenuComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: __webpack_require__(/*! raw-loader!./side-menu.component.html */ "./node_modules/raw-loader/index.js!./src/app/components/side-menu/side-menu.component.html"),
...
APP_CONSTANTS.API_ENPOINT = 'https://dhapp.digitalhousing.in/api';
...
class User {
    constructor(isActive, userName, userType) {
...
/* harmony import */ var _core_app_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../core/app.constants */ "./src/app/core/app.constants.ts");
/* harmony import */ var _core_api_endpoints__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../core/api.endpoints */ "./src/app/core/api.endpoints.ts");
...
let ApiService = class ApiService {
    ...
    request(endPointName, payload = {}, restFull = false) {
        let endPointData = _core_api_endpoints__WEBPACK_IMPORTED_MODULE_4__["API_ENDPOINT"].data()[endPointName];
        return this.http.request(endPointData.method, `${_core_app_constants__WEBPACK_IMPORTED_MODULE_3__["APP_CONSTANTS"].API_ENPOINT}/${endPointData.url}`, { body: payload, observe: 'body' });
    }
};
...
/***/ "./src/app/services/auth-garud.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/auth-garud.service.ts ***!
  \************************************************/
...
let AuthService = class AuthService {
    constructor(apiService, storage, router) {
    ...
    fillAuthData(res) {
        this.user = new _models_user_model__WEBPACK_IMPORTED_MODULE_5__["User"](res.isActive, 'NA', res.userTypeId);
        this.token = res.token;
        this.isAuthenticated = true;
    }
    logout() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.storage.remove('authData');
    ...
    isLoggedIn() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let res = yield this.storage.get('authData');
            return new Promise((resolve, reject) => {
                if (res) {
                    this.fillAuthData(res);
                    resolve(true);
...
module.exports = __webpack_require__(/*! /Users/ravsharma/learn/ionic4base/src/main.ts */"./src/main.ts");
